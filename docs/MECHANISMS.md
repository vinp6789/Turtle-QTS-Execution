...
| **Trend continuation** | OHLCV candles | **Yes — Track B + sibling repo** `[R]` | **Negative.** Hit 0.4353, z = −3.5 `[M]`; permanently rejected in the sibling research repo `[R]` | No | **CLOSED (Constitution §4).** Not an open slot |
