...
**Totals:** 9 packages, 9 test files, **305 tests collected** (plus 5
...
("completed and frozen Execution Engine Modules 1–9").
...
- **# Tests** counts test methods collected by pytest per file; the
  per-file sum (22+41+37+42+41+23+22+21+56) equals the collected total
  **305**.
